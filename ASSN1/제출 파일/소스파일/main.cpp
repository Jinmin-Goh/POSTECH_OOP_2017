	...
	while (true)
	{
		...
		else if (menunum == "2") // 메뉴 2 - 메뉴 추가
		{
			...
			if (menunum == "1")
			{
				...
				if (toppinglist.pick(toppingtitle) != NULL)	// 이미 있는 메뉴
				{
					cout << "이미 있는 메뉴입니다. 초기 메뉴로 돌아갑니다." << endl;
					delete topping;
					continue;
				}
			...
			else if (menunum == "2")
			{
				...
				if (doughlist.pick(doughtitle) != NULL)	// 이미 있는 메뉴
				{
					cout << "이미 있는 메뉴입니다. 초기 메뉴로 돌아갑니다." << endl;
					delete dough;
					continue;
			...
			else if (menunum == "3")
			{
				...
				if (edgelist.pick(edgetitle) != NULL)	// 이미 있는 메뉴
				{
					cout << "이미 있는 메뉴입니다. 초기 메뉴로 돌아갑니다." << endl;
					delete edge;
					continue;
		...
		else if (menunum == "4")	// 메뉴 4 - 검색
		{
			...
			if (menunum == "1")		// 토핑
			{
				...
				if (menunum == "1")		// 재료로 검색
				{
					...
					if (ingtitle == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
				...
				else if (menunum == "2") // 가격으로 검색
				{
					...
					if (lpricestring == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
					...
					if (hpricestring == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
			...
			else if (menunum == "2")	// 도우
			{
				...
				if (menunum == "1")		// 두께로 검색
				{
					...
					if (lvaluestring == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
					...
					if (hvaluestring == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
			...
			else if (menunum == "3")	// 에지
			{
				...
				if (menunum == "1")		// 무스로 검색
				{
					...
					if (moussetitle == "")	// 문자 입력 없이 엔터 입력 시 에러 출력
					{
						cout << "잘못된 입력입니다. 초기 메뉴로 돌아갑니다." << endl;
						continue;
					}
